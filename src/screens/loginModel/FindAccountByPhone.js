...
import { SafeAreaView, Text, View, StyleSheet, TouchableHighlight, AsyncStorage } from 'react-native';
        ...
        return (
            <View style={styles.mainTitleContainer}>
                <View style={styles.mainTitleH1}>
                    <Text style={styles.H1Text}>手机号码找回</Text>
                </View>
            </View>
        );
    }
...
class InputField extends PureComponent {
    ...
    login = () => {
        ...
        Api.findAccountByPhone(reg.mobile, reg.verCode, reg.code, (e, code, message) => {//reg.verCode
            if (message == 'success') {
        ...
        return (
            <View style={styles.inputFieldContainer}>
                ...
                <TouchableHighlight style={styles.loginBtn} onPress={this.login}>
                    <Text style={styles.loginBtnText}>立即找回</Text>
                </TouchableHighlight>
            </View>
        );
    }
