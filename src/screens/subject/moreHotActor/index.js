        ...
        return (
            <TouchableHighlight style={styles.itemContainer} onPress={this._press} underlayColor='transparent'>
                <View style={styles.itemFlexView}>
                    ...
                    <SecurtyImage style={styles.image} default={require('../../../image/usual/avater_load_failed.png')} imageStyle={{ height: 66, width: 66, borderRadius: 33 }} source={{ uri: this.props.item.cover_path }} />
