        ...
        return (
            <View style={{ marginHorizontal: 18 }}>
                ...
                <View style={{ paddingHorizontal: 17, alignSelf: 'center', backgroundColor: 'rgb(51,57,62)', borderRadius: 5 }}>
                    ...
                    <Text style={{ fontSize: 13, color: 'rgb(232,232,232)', marginTop: 13, marginBottom: 24, lineHeight: 19 }}>{this.props.msg}</Text>
                </View>
            </View>
        );
    }
...
export default class MyMessageScreen extends PureComponent {
    ...
    render() {
        return (
            <SafeAreaView style={{ flex: 1, backgroundColor: Colors.SCREEN_BGCOLOR }}>
                <View style={{ flex: 1 }}>
                    <ModalHeader goBack={this._goBack} textStyle={{ color: 'white' }} backBtnColor='rgb(255,255,255)' title='我的消息' rightBtnMode='none' />
