        ...
        return (
            <View style={{ flex: 1, backgroundColor: 'white' }}>
                ...
                <SafeAreaView style={{ flex: 1 }}>
                    <View style={{ flex: 1 }}>
                        <ModalHeader isDisableBack={true} textStyle={{ color: 'white',fontSize:16 }} backBtnColor='rgb(255,255,255)' title={In18.TASK_CENTER} rightBtnMode='text' rightBtnTitle='邀请记录' rightBtnOnPress={this._inviteDetails} />
